(function () {
  ...
  class Shader {
    constructor(options = {}) {
      ...
      this.width = isMobile ? 200 : 250; // Smaller on mobile
      this.height = isMobile ? 120 : 150; // Smaller on mobile
    ...
    createElement() {
      // Create container with responsive sizing
      ...
      // Rest of the createElement code remains the same
